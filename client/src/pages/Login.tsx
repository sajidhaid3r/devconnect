...
export default function Login() {
  ...
  // Construct the full URL pointing to your Railway backend
  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 py-12">
      <div className="glass-card w-full max-w-md p-8 sm:p-10 animate-scale-in relative overflow-hidden">
        ...
        <div className="absolute -bottom-12 -left-12 w-28 h-28 bg-magenta-600/20 rounded-full blur-2xl pointer-events-none" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="btn-primary w-full py-3 text-sm font-semibold tracking-wide disabled:opacity-60 mt-2"
          >
        ...
        {/* Points directly to Railway API */}
        <a
          href={githubAuthUrl}
        ...
        <p className="text-xs text-lavender-300/70 mt-6 text-center">
          ...
          <Link to="/register" className="text-violet-400 hover:text-magenta-400 font-semibold transition-colors">
            Sign up
          </Link>
        </p>
      </div>
